...
export type GenericMorph = ComponentNavbarHeader | ComponentTimesHora | Event | HorariosMissa | I18NLocale | Pastoral | PastoralTemplate | UploadFile | UploadFolder | UsersPermissionsPermission | UsersPermissionsRole | UsersPermissionsUser;
