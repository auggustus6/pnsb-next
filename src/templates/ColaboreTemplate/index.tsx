          ...
          <Styles.SocialWorkItem>
            ...
            <Styles.SocialWorkContent>
              <div>
                ...
                <p>
                  Nossa Obra Social auxilia crianças de 07 a 12 anos com
                  educação, esporte, atendimento psicológico e muito mais.
                </p>
          ...
          <Styles.SocialWorkItem $inverse>
            ...
            <Styles.SocialWorkContent>
              <div>
                ...
                <p>
                  Você pode ajudar nossos irmãos em situação de rua doando
                  roupas, sabonete, aparelho de barbear descartável, shampoo e
                  também ajudar seus animais doando ração, vermífugos e shampoo.
                </p>
          ...
          <Styles.SocialWorkItem>
            ...
            <Styles.SocialWorkContent>
              <div>
                ...
                <p>
                  Aos sábados e domingos de manhã, damos banhos, fornecemos
                  ração, vermifugamos e prestamos outros cuidados aos cães dos
                  moradores em situação de rua, com supervisão de veterinários.
                </p>
                <p>
          ...
          <Styles.SocialWorkItem $inverse>
            ...
            <Styles.SocialWorkContent>
              <div>
                ...
                <p>
                  Mensalmente doamos cestas básicas à famílias carentes, você
                  pode ajudar deixando sua doação na secretaria da paróquia.
                </p>
              </div>
            </Styles.SocialWorkContent>
          </Styles.SocialWorkItem>
